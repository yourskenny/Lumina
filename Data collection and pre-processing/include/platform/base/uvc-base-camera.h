...
namespace SY3_NAMESPACE
{
	...
	namespace platform
	{
		...
		public:
			...
			int get_calib_depth_320_240(ParamentsCalib &paraments_calib_depth_320_240) override;

			int get_calib_depth_640_480(ParamentsCalib &paraments_calib_depth_640_480) override;
